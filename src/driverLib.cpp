...
bool driver_m3d::writeParam(int paramNo, int subindex, int paramValue)
{
    ...
    printf("received from m3d %s", std::string(buf.begin(), buf.begin()+len).c_str());
    return true;
}
...
bool driver_m3d::getParam (int paramNo, int subindex, int &paramValue)
{
    ...
    //printf("recived from m3d %s", std::string(buf.begin(), buf.begin()+len).c_str());
